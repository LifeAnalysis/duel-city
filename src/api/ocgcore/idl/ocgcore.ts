    ...
    export namespace CtosGameMsgResponse {
        ...
        export class SelectPlaceResponse extends pb_1.Message {
            ...
            constructor(data?: any[] | {
                ...
                zone?: CardZone;
                sequence?: number;
                places?: CtosGameMsgResponse.SelectPlaceResponse.Place[];
            }) {
                super();
            ...
            get places() {
                return pb_1.Message.getRepeatedWrapperField(this, CtosGameMsgResponse.SelectPlaceResponse.Place, 4) as CtosGameMsgResponse.SelectPlaceResponse.Place[];
            }
            set places(value: CtosGameMsgResponse.SelectPlaceResponse.Place[]) {
            ...
            static fromObject(data: {
                ...
                zone?: CardZone;
                sequence?: number;
                places?: ReturnType<typeof CtosGameMsgResponse.SelectPlaceResponse.Place.prototype.toObject>[];
            }): SelectPlaceResponse {
                ...
                if (data.places != null) {
                    message.places = data.places.map(item => CtosGameMsgResponse.SelectPlaceResponse.Place.fromObject(item));
                }
                return message;
            }
            toObject() {
                ...
                if (this.places != null) {
                    data.places = this.places.map((item: CtosGameMsgResponse.SelectPlaceResponse.Place) => item.toObject());
                }
                return data;
            }
            serialize(): Uint8Array;
            ...
            serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
                ...
                if (this.places.length)
                    writer.writeRepeatedMessage(4, this.places, (item: CtosGameMsgResponse.SelectPlaceResponse.Place) => item.serialize(writer));
                if (!w)
                    return writer.getResultBuffer();
            }
                ...
                while (reader.nextField()) {
                    ...
                    switch (reader.getFieldNumber()) {
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            reader.readMessage(message.places, () => pb_1.Message.addToRepeatedWrapperField(message, 4, CtosGameMsgResponse.SelectPlaceResponse.Place.deserialize(reader), CtosGameMsgResponse.SelectPlaceResponse.Place));
                            break;
                        default: reader.skipField();
                    }
                }
        ...
        export namespace SelectPlaceResponse {
            export class Place extends pb_1.Message {
                #one_of_decls: number[][] = [];
                constructor(data?: any[] | {
                    player?: number;
                    zone?: CardZone;
                ...
                static deserialize(bytes: Uint8Array | pb_1.BinaryReader): Place {
                    const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new Place();
                    while (reader.nextField()) {
                        if (reader.isEndGroup())
                            break;
                        switch (reader.getFieldNumber()) {
                ...
                static deserializeBinary(bytes: Uint8Array): Place {
                    return Place.deserialize(bytes);
                }
            }
        }
    ...
    export namespace StocGameMessage {
        ...
        export class MsgMove extends pb_1.Message {
            ...
            serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
                ...
                if (this.reason != 0)
                    writer.writeUint32(4, this.reason);
                if (!w)
                    return writer.getResultBuffer();
            }
        ...
        export class MsgSwap extends pb_1.Message {
            ...
            constructor(data?: any[] | {
                code1?: number;
                location1?: CardLocation;
                code2?: number;
                location2?: CardLocation;
            }) {
                super();
                pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
                if (!Array.isArray(data) && typeof data == "object") {
                    if ("code1" in data && data.code1 != undefined) {
                        this.code1 = data.code1;
                    }
                    if ("location1" in data && data.location1 != undefined) {
                        this.location1 = data.location1;
                    }
                    if ("code2" in data && data.code2 != undefined) {
                        this.code2 = data.code2;
                    }
                    if ("location2" in data && data.location2 != undefined) {
            ...
            set code1(value: number) {
                pb_1.Message.setField(this, 1, value);
            }
            get location1() {
                return pb_1.Message.getWrapperField(this, CardLocation, 2) as CardLocation;
            }
            set location1(value: CardLocation) {
                pb_1.Message.setWrapperField(this, 2, value);
            }
            get has_location1() {
                return pb_1.Message.getField(this, 2) != null;
            ...
            set code2(value: number) {
                pb_1.Message.setField(this, 3, value);
            }
            get location2() {
                return pb_1.Message.getWrapperField(this, CardLocation, 4) as CardLocation;
            }
            set location2(value: CardLocation) {
            ...
            static fromObject(data: {
                code1?: number;
                location1?: ReturnType<typeof CardLocation.prototype.toObject>;
                code2?: number;
                location2?: ReturnType<typeof CardLocation.prototype.toObject>;
            }): MsgSwap {
                const message = new MsgSwap({});
                if (data.code1 != null) {
                    message.code1 = data.code1;
                }
                if (data.location1 != null) {
                    message.location1 = CardLocation.fromObject(data.location1);
                }
                if (data.code2 != null) {
                    message.code2 = data.code2;
                }
                if (data.location2 != null) {
                    message.location2 = CardLocation.fromObject(data.location2);
                }
                return message;
            }
            toObject() {
                ...
                if (this.location1 != null) {
                    data.location1 = this.location1.toObject();
                }
                if (this.code2 != null) {
                    data.code2 = this.code2;
                }
                if (this.location2 != null) {
                    data.location2 = this.location2.toObject();
                }
                return data;
            }
            serialize(): Uint8Array;
            ...
            serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
                const writer = w || new pb_1.BinaryWriter();
                if (this.code1 != 0)
                    writer.writeInt32(1, this.code1);
                if (this.has_location1)
                    writer.writeMessage(2, this.location1, () => this.location1.serialize(writer));
                if (this.code2 != 0)
                    writer.writeInt32(3, this.code2);
                if (this.has_location2)
                    writer.writeMessage(4, this.location2, () => this.location2.serialize(writer));
                if (!w)
                    return writer.getResultBuffer();
            }
            static deserialize(bytes: Uint8Array | pb_1.BinaryReader): MsgSwap {
                ...
                while (reader.nextField()) {
                    ...
                    switch (reader.getFieldNumber()) {
                        case 1:
                            message.code1 = reader.readInt32();
                            break;
                        case 2:
                            reader.readMessage(message.location1, () => message.location1 = CardLocation.deserialize(reader));
                            break;
                        case 3:
                            message.code2 = reader.readInt32();
                            break;
                        case 4:
                            reader.readMessage(message.location2, () => message.location2 = CardLocation.deserialize(reader));
                            break;
                        default: reader.skipField();
                    }
                }
